              ...
              categories.map((item) => {
                return (
                  <option
                    ...
                    className="text-based border-0 outline-none capitalize bg-white text-headingColor"
                  >
                    {item.name}
                  </option>
                );
              ...
              {!imageAsset ? (
                ...
                <>
                  <div className="relative h-full">
                    ...
                    <button
                      type="button"
                      className="absolute bottom-3 right-3 p-3 rounded-full bg-red-500 text-xl cursor-pointer outline-none hover:shodow-md duration-100 transition-all ease-in-out"
                      onClick={deleteImage}
                    >
